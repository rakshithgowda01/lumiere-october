...
export function ScheduleCalendar({ showHoverGradient = true, hideOverflow = true }: { showHoverGradient?: boolean; hideOverflow?: boolean }) {
  ...
  return (
    <BentoCard height="h-auto" linkTo={bookingLink} showHoverGradient={showHoverGradient} hideOverflow={hideOverflow}>
      <div className=" grid h-full  gap-5">
        <div className="">
          ...
          <Button asChild className="mt-3 rounded-2xl">
            <a href={bookingLink} target="_blank" rel="noopener noreferrer">Book Now</a>
          </Button>
        </div>
