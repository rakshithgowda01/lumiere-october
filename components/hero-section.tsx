    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden z-0">
      ...
      >
        ...
        >
          <Magnet strength={0.2}>
            <button
              className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full transition-all duration-300 font-medium text-lg flex items-center space-x-2 mx-auto hover:bg-white hover:text-black hover:scale-105 active:scale-95 font-mono"
              onClick={() => {
